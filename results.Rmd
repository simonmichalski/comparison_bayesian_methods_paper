...
\begin{table}[H]
    ...
    dBF\textsubscript{+-} (lower) & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.05,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.1,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.2,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.5,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 1,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 1.5,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 2,"directional_bf_lower"])` & \centering `r round_and_format_down(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 2.5,"directional_bf_lower"])`\arraybackslash\\
