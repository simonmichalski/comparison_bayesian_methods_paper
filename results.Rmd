...
\begin{table}[H]
    ...
    HDI decision rule & \centering `r proportion_to_percentage(ps_hdi_sim_0_2)` & \centering `r proportion_to_percentage(ps_hdi_sim_0_51)` & \centering `r proportion_to_percentage(ps_hdi_sim_0_81)`\arraybackslash\\
