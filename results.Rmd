...
sim_based_thres <- readRDS(file.path("results", "sim_based_thresholds.rds"))
...
\begin{table}[H]
    ...
    dBF\textsubscript{+-} (upper) & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.05,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.1,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.2,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.5,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 1,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 1.5,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 2,"directional_bf_upper"])` & \centering `r round_and_format(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 2.5,"directional_bf_upper"])`\arraybackslash\\
    ...
    HDI width (\%) & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.05,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.1,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.2,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 0.5,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 1,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 1.5,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 2,"hdi"])` & \centering `r proportion_to_percentage(df_sim_thres_prior[df_sim_thres_prior$prior_sd == 2.5,"hdi"])`\arraybackslash\\
    \midrule
    \end{tabularx}
\end{table}
```
...
\begin{table}[H]
    ...
    \midrule
    Savage-Dickey $BF_{10}$ & \centering `r proportion_to_percentage(ps_savage_dickey_bf_sim_0_2)` & \centering `r proportion_to_percentage(ps_savage_dickey_bf_sim_0_51)` & \centering `r proportion_to_percentage(ps_savage_dickey_bf_sim_0_81)`\arraybackslash\\
    $dBF_{+-}$ & \centering `r proportion_to_percentage(ps_directional_bf_sim_0_2)` & \centering `r proportion_to_percentage(ps_directional_bf_sim_0_51)` & \centering `r proportion_to_percentage(ps_directional_bf_sim_0_81)`\arraybackslash\\
